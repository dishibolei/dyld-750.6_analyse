...
void ImageLoader::link(const LinkContext& context, bool forceLazysBound, bool preflightOnly, bool neverUnload, const RPathChain& loaderRPaths, const char* imagePath)
{
	...
	__block uint64_t t2, t3, t4, t5;
	{
		...
		// 递归rebase库,最终调用  ImageLoaderMachOCompressed::rebase 的rebaseAt，利用edit里面的rebase info记录的命令来构建
	...
	// interpose any dynamically loaded images // bind 注入的那些动态库，非主工程才可以
	...
	// 注册DOF（DTrace Object Format）节，recursiveGetDOFSections
	...
	fgTotalLoadLibrariesTime += t1 - t0; // 加载lib库的时间
	fgTotalRebaseTime += t3 - t2; // rebase的时间
	fgTotalBindTime += t4 - t3; // bind时间
	fgTotalWeakBindTime += t5 - t4; // weak bind的时间
	fgTotalDOF += t7 - t6; // 加载DOF的时间
